...
@Component({
    selector: 'formly-wrapper-field-array-designer',
    template: `
        ...
        <div class="content" [ngClass]="{preview: preview}">
            ...
            <div *ngIf="!editing">
                <formly-designer [fields]="childFields" class="container-fluid"
                    (fieldsChanged)="onChildFieldsChanged($event)">
                </formly-designer>
            </div>
            <div [hidden]="true">
...
export class FormlyWrapperFieldArrayDesignerComponent extends FieldWrapper implements OnInit {
    ...
    ngOnInit(): void {
        this.childFields = this.field.fieldArray.fieldGroup ? this.field.fieldArray.fieldGroup : [];
    }
    ...
    onChildFieldsChanged(childFields: FormlyFieldConfig[]): void {
        this.formlyDesignerService.updateField(this.field.fieldArray, { fieldGroup: childFields });
    }
}
